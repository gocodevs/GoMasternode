...
#   c) node1 mines 32 blocks, so now node 0 has 60001goc, node 1 has 4250goc, node2 has none.
#   d) node0 sends 601 goc to node2, in two transactions (301 goc, then 300 goc).
