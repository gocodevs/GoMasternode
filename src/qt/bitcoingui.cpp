                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gocoin Core") + " - ";
#ifdef ENABLE_WALLET
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGOC"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gocoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gocoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gocoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Gocoin Core help message to get a list with possible Gocoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Gocoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Gocoin Core"); // default title
