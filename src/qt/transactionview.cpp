 ...
 */
    ...
    typeWidget->addItem(tr("Received Goc from zGoc"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGoc"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGoc));
