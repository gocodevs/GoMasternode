...
def determine_db_dir():
    """Return the default location of the gocoin data directory"""
    if platform.system() == "Darwin":
        return os.path.expanduser("~/Library/Application Support/Gocoin/")
    elif platform.system() == "Windows":
        return os.path.join(os.environ['APPDATA'], "Gocoin")
    return os.path.expanduser("~/.gocoin")

def read_bitcoin_config(dbdir):
    """Read the gocoin.conf file from dbdir, returns dictionary of settings"""
    ...
    config_parser.readfp(FakeSecHead(open(os.path.join(dbdir, "gocoin.conf"))))
    return dict(config_parser.items("all"))

def connect_JSON(config):
    """Connect to a gocoin JSON-RPC server"""
...
def list_available(blocknoded):
    ...
    for output in unspent:
        ...
        # This code only deals with ordinary pay-to-gocoin-address
...
def main():
    ...
    parser.add_option("--datadir", dest="datadir", default=determine_db_dir(),
                      help="location of gocoin.conf file with RPC username/password (default: %default)")
