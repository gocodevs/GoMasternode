...
In order to support loading of multiple wallets in gocoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gocoin.cpp.
...
Changes to gocoin.cpp
----------------------
gocoin.cpp is the entry point into gocoin-qt, and as such, will require some minor modifications to provide hooks for
