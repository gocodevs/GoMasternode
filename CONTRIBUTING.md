Contributing to Gocoin Core
============================

The Gocoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Gocoin Core project, and is not to be
confused with overall Gocoin Network Protocol consensus changes.

Whether a pull request is merged into Gocoin Core rests with the project merge
...
Patches that change Gocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gocoin consensus, it must have been
...
The project leader is the release manager for each Gocoin Core release.
